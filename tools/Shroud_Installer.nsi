...
Name "Shroud Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_Shroud_${VERSION}.exe"
...
; Sections
Section "Shroud" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\Shroud"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\Shroud\Plugin_Shroud.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\Shroud\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\Shroud"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\Shroud\Plugin_Shroud.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\Shroud\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_Shroud"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_Shroud\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Shroud Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the Shroud Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Shroud Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_Shroud\changelog.md"'
FunctionEnd
